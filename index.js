...
function reiniciarJogo() {
    var confirmacao = confirm("Tem certeza que deseja reiniciar o jogo?");

    if (confirmacao) {
        jogadores = [];
        var espacoCartelas = document.getElementById('espaco_cartelas');
        espacoCartelas.innerHTML = "";
    }
}

function desenharCartela(nome, cartela) {
    var div = document.getElementById('cartelas-container');
    ...
    div.appendChild(divCartela);
    
}

function sortearNumeros() {
    // Implemente a lógica para sortear números e exibir na interface
}
